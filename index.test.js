...
test('Use input [ 3, 9, 1, null, null, 7, 17 ], output TreeNode.', () => {
  const root = [3, 9, 1, null, null, 7, 17];
  const actual = arrayToBinaryTree(root);
...
test('Use input [ 3, 9, 1, 7], output TreeNode.', () => {
  const root = [3, 9, 1, 7];
  const actual = arrayToBinaryTree(root);
  const expected = new TreeNode(
    3,
...
test('Use input [ 3, 9, 1, 7, 7, 7, 17 ], output TreeNode.', () => {
  const root = [3, 9, 1, 7, 7, 7, 17];
  const actual = arrayToBinaryTree(root);
  const expected = new TreeNode(
    3,
    new TreeNode(9,
...
test('Use input [ null ], output TreeNode.', () => {
  const root = [ null ];
  const actual = arrayToBinaryTree(root);
  const expected = new TreeNode(null);

  expect(actual).toEqual(expected);
});

test('Use input [ null, 1, 5 ], output TreeNode.', () => {
  const root = [null, 1, 5];
  const actual = arrayToBinaryTree(root);
  const expected = new TreeNode(null, new TreeNode(1), new TreeNode(5));
